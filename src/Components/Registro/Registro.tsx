  ...
  return (
    <main className="flex flex-col items-center justify-center h-screen mx-auto relative">
      ...
      <form
        ...
        className="relative w-full max-w-lg flex flex-col items-center gap-4 p-6 rounded-3xl border border-[#cb0c4f] bg-white bg-opacity-15 backdrop-blur-lg" // Cambiado a max-w-lg para ajustar el ancho
      >
        <div className="flex flex-col items-center justify-center mb-4">
          <h2 className="text-3xl font-bold text-[#cb0c4f] text-center">Registro</h2>
          <img src={User} alt="user icon" className="w-24 h-24 md:w-32 md:h-32" />
        </div>
