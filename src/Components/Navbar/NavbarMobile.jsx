...
const NavbarMobile = () => {
  ...
  const iconColorStyle = {
    filter: "invert(29%) sepia(72%) saturate(3094%) hue-rotate(327deg) brightness(92%) contrast(93%)",
  };
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <a href="https://www.facebook.com">
            <img className={iconStyle} src={Facebook} alt="Facebook" style={iconColorStyle} />
          </a>
          <a href="https://www.instagram.com">
            <img className={iconStyle} src={Instagram} alt="Instagram" style={iconColorStyle} />
          </a>
          <a href="https://wa.me/1234567890">
            <img className={iconStyle} src={Whatsapp} alt="Whatsapp" style={iconColorStyle} />
          </a>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-2">
        {isHomePage ? (
          ...
          <div className="flex space-x-3">
            <Link to="/quienes-somos" className="text-[#cb0c4f] hover:text-gray-300">
              ¿Quiénes Somos?
            </Link>
            ...
            <Link to="/opiniones" className="text-[#cb0c4f] hover:text-gray-300">
              Opiniones
            </Link>
            <span
